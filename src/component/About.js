    ...
    return (
        <VStack  py={10} >
            ...
            <Flex alignItems="center" >
                <Card w={isNotSmallerScreen ? "65%":"83%"} boxShadow="8px 4px 4px rgba(0, 0, 0, 0.25)" borderRadius="10px">
                    ...
                    <CardBody display="flex" flexDirection="row" gap={2}>
                        ...
                        <Box w={isNotSmallerScreen ?"543px":"390px"} >
                            ...
                            <Text fontFamily='Raleway' fontWeight="medium" fontSize={isNotSmallerScreen ? "17.2px":"11px" }>
