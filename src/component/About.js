                ...
                <Card w="65%" boxShadow="8px 4px 4px rgba(0, 0, 0, 0.25)" borderRadius="10px">
                    ...
                    <CardBody display="flex" flexDirection="row" gap={4}>
                        ...
                        <Box w="543px" alignSelf="center">
                            <Text fontFamily='Raleway' fontWeight="medium" fontSize="15px">Ingénieur des Travaux Informatiques option Génie Logiciel, je suis un développeur full stack et au même titre un web designer.<br />
